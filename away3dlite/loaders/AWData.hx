		...
		for (line in lines)
		{
				...
				if(state == "#o"){
					...
					if(buffer == 0){
							...
							//var temparr:Vector<Float> = Vector.ofArray([FastStd.parseFloat(dline[1]),FastStd.parseFloat(dline[5]),FastStd.parseFloat(dline[9]),FastStd.parseFloat(dline[2]),FastStd.parseFloat(dline[6]),FastStd.parseFloat(dline[10]),FastStd.parseFloat(dline[3]),FastStd.parseFloat(dline[7]),FastStd.parseFloat(dline[11]),FastStd.parseFloat(dline[4]),FastStd.parseFloat(dline[8]),FastStd.parseFloat(dline[12]),0,0,0,1]);
							m = new Matrix3D(Vector.ofArray([FastStd.parseFloat(dline[1]),FastStd.parseFloat(dline[2]),FastStd.parseFloat(dline[3]),FastStd.parseFloat(dline[4]),FastStd.parseFloat(dline[5]),FastStd.parseFloat(dline[6]),FastStd.parseFloat(dline[7]),FastStd.parseFloat(dline[8]),FastStd.parseFloat(dline[9]),FastStd.parseFloat(dline[10]),FastStd.parseFloat(dline[11]),FastStd.parseFloat(dline[12]),0,0,0,1]));
							++buffer;
					} else {
				...
				if(state == "#c" && !isMesh){
					...
					//m = new Matrix3D(Vector.ofArray([FastStd.parseFloat(dline[1]),FastStd.parseFloat(dline[5]),FastStd.parseFloat(dline[9]),FastStd.parseFloat(dline[2]),FastStd.parseFloat(dline[6]),FastStd.parseFloat(dline[10]),FastStd.parseFloat(dline[3]),FastStd.parseFloat(dline[7]),FastStd.parseFloat(dline[11]),FastStd.parseFloat(dline[4]),FastStd.parseFloat(dline[8]),FastStd.parseFloat(dline[12]),0.0,0.0,0.0,1.0]));
					m = new Matrix3D(Vector.ofArray([FastStd.parseFloat(dline[1]),FastStd.parseFloat(dline[2]),FastStd.parseFloat(dline[3]),FastStd.parseFloat(dline[4]),FastStd.parseFloat(dline[5]),FastStd.parseFloat(dline[6]),FastStd.parseFloat(dline[7]),FastStd.parseFloat(dline[8]),FastStd.parseFloat(dline[9]),FastStd.parseFloat(dline[10]),FastStd.parseFloat(dline[11]),FastStd.parseFloat(dline[12]),0.0,0.0,0.0,1.0]));
