...
class Material extends EventDispatcher
{
	...
	private static var DEBUG_STROKE:GraphicsStroke = new GraphicsStroke (1, false, LineScaleMode.NORMAL, CapsStyle.NONE, JointStyle.ROUND, 0, new GraphicsSolidFill(0xFF00FF));
